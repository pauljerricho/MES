...
$copied_file_name = $file_upload->file_upload_("upfile","$_SERVER[DOCUMENT_ROOT]/data/",date("Y_m_d_d_H_i_s"));
...
$sql = $dbi_insert->dbi_insert_("board","id,name,subject,content,regist_day,hit,file_name,file_type,file_copied","'$_SESSION[userid]','$_SESSION[username]','$subject','$content','$regist_day',0,'$upfile_name','$upfile_type','$copied_file_name'");
...
$sql = $dbi_update->dbi_update_("members","point='$new_point'","id='$_SESSION[userid]'");
$db_connect->db_close();
