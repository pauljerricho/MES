...
<div id="main_content" class="fontstyle">
    <div id="latest">
        ...
        if(!$result){
            echo ("<li>게시판 DB테이블 (board)이 생성 전이거나 아직 게시글이 없습니다</li>");
        }else{
...
?>
    ...
    <div id="point_rank">
        ...
        if(!$result){
            echo ("<li>게시판 DB테이블 (members)이 생성 전이거나 아직 게시글이 없습니다</li>");
        }else {
        $rank = 1;
