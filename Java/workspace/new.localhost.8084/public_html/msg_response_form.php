...
<section class="fontstyle">
    ...
    <form  name="msg_form" method="post" action="msg_insert.php">
       <input type="hidden" name="rv_id" value="<?=$row2['id']?>">
       
       <!--<input type="hidden" name="send_id" value="<?=$row['userid']?>">-->
       <div id="write_msg">
           <ul>
         <li>
